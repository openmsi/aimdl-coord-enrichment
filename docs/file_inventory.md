...
| `aimdl_coord_enrichment/partitions.py` | 16 | N/A — `HELIX_TRACE_PARTITIONS` definition |
...
| `aimdl_coord_enrichment/sensors.py` | 148 | N/A — `helix_trace_discovery_sensor` + `maxima_run_discovery_sensor` |
